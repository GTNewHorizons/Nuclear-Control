...
@Mod(modid = "IC2NuclearControl", name = "Nuclear Control 2", version = "2.4.4a", dependencies = "required-after:IC2; after:gregtech;", guiFactory = "shedar.mods.ic2.nuclearcontrol.gui.GuiFactory")
